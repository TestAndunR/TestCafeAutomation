...
exports.handler = function (event, context, callback) {
	cognito_idp.adminCreateUser({
		...
		UserAttributes: [{ Name: 'name', Value: 'Andun' }, { Name: 'email', Value: 'andun@adroitlogic.com' }, { Name: 'birthdate', Value: '01.02.1993' }, { Name: 'phone_number', Value: '+94770630943' }, { Name: 'address', Value: 'Galle' }],
		ValidationData: []
	}, function (error, data) {
		if (error) {
